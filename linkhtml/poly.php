...
$notice_danim = "SELECT * FROM FabricNotice Where FabricId =2;";
...
$delete ='';
if(isset($_GET['id'])) {
    $update= '<a href="poly_update.php?id='.$_GET['id'].'"> update</a>';
    $delete= '
    <form action="poly_process_delete.php" method="post">
